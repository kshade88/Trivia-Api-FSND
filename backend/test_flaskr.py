...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_404_sent_requestions_beyond_valid_page(self):
    ...
    def test_422_delete_id_not_valid(self):
    ...
    def test_422_create_new_question_invalid(self):
    ...
    def test_422_questions_by_invalid_category_id(self):
    ...
    def test_400_search_item_invalid(self):
    ...
    def test_post_quiz_question(self):
        res = self.client().post('/quizzes', json={'previous_questions': [1], 'quiz_category': {"id": 2}})
        data = json.loads(res.data)
